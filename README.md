...
| 'Beta' bank's historical customer data | Yandex Practicum | It is necessary to predict whether the client will leave the bank in the near future or not. | Metric: F1>0.59; Reached metric: 0.607; Tools: Python,Pandas, Matplotlib, Seaborn, Numpy, RandomForestClassifier, DummyClassifier, DecisionTreeClassifier, upsample, downsample | [Link](https://github.com/Vol4uk13/master/tree/master/Learning_with_teacher) |
| Customers data of the insurance company "Хоть Потоп" | Yandex Practicum | It is necessary to develop a method for encrypting personal data. | Tools: Python,Pandas, Matplotlib, Seaborn, Numpy, LinearRegression, Pipeline, LaTeX | [Link](https://github.com/Vol4uk13/master/tree/master/Linear_algebra) |
