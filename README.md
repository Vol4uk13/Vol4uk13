...
| Federal mobile operator 'Megaline' | Yandex Practicum | It is necessary to analyze the behavior of customers and conclude which tariff is better. | Tools: Python, Pandas, Matplotlib, Seaborn, Numpy. Hypothesis testing. | [Link](https://github.com/Vol4uk13/master/tree/master/Statistical_data_analysis) |
