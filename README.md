...
| Federal mobile operator 'Megaline' | Yandex Practicum | It is necessary to analyze the behavior of customers and conclude which tariff is better. | Tools: ![Python](https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54), Pandas, Matplotlib, Seaborn, Numpy. Hypothesis testing. | [Link](https://github.com/Vol4uk13/master/tree/master/Statistical_data_analysis) |

### Time series analysis

| name | source | short description | metrics and tools | links |
| --- | --- | --- |  --- | --- |
|The company "Чëтенькое такси" has collected historical data on taxi orders at airports. | Yandex Practicum | It is necessary to predict the number of taxi orders for the next hour. | Metric: RMSE<48 Reached metric:42.97  Tools: ![Python](https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54), Pandas, Matplotlib, Seaborn, Numpy, Scikit-learn (Sklearn) | [Link](https://github.com/Vol4uk13/master/tree/master/Time_series) |

### Computer vision

| name | source | short description | metrics and tools | links |
| --- | --- | --- |  --- | --- |
| Supermarket "Bread-Salt" introduces a computer  vision system for processing customer photos. | Yandex Practicum | It is necessary to develop a linear regression model that can determine  the approximate age of a person from a photo. | Metric: MAE>8; Reached metric: 5.55; Tools: ![Python](https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54), Pandas, Matplotlib, Seaborn, Numpy, Tensorflow, Krras.  | [Link](https://github.com/Vol4uk13/master/tree/master/Computer_vision) |
...
| 'Beta' bank's historical customer data (Classification task) | Yandex Practicum | It is necessary to predict whether the client will leave the bank in the near future or not. | Metric: F1>0.59; Reached metric: 0.607; Tools: ![Python](https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54) ,Pandas, Matplotlib, Seaborn, Numpy, RandomForestClassifier, DummyClassifier, DecisionTreeClassifier, upsample, downsample | [Link](https://github.com/Vol4uk13/master/tree/master/Learning_with_teacher) |
| Customers data of the insurance company "Хоть Потоп" (Regression task) | Yandex Practicum | It is necessary to develop a method for encrypting personal data. | Tools: ![Python](https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54),Pandas, Matplotlib, Seaborn, Numpy, LinearRegression, Pipeline, ![LaTeX](https://img.shields.io/badge/latex-%23008080.svg?style=for-the-badge&logo=latex&logoColor=white) | [Link](https://github.com/Vol4uk13/master/tree/master/Linear_algebra) |
| Mining company «ГлавРосГосНефть» (Regression task) | Yandex Practicum | We need to build a machine learning model that will help determine the region where mining will bring the greatest profit. Analyze the possible profits and risks with the Bootstrap technique. |  Metric: lowest risk and highest profit by region;  Tools: ![Python](https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54),Pandas, Matplotlib, Seaborn, Numpy, LinearRegression, StandardScaler | [Link](https://github.com/Vol4uk13/master/tree/master/ML_in_business) |
| Service for the sale of used cars "Not beaten, not painted" | Yandex Practicum | It is necessary to build a model for determining the cost of cars, trained from historical customer data. | Metric: RMSE<2,500; Reached metric: 1,601.29; Tools: ![Python](https://img.shields.io/badge/python-3670A0?style=for-the-badge&logo=python&logoColor=ffdd54),Pandas, Matplotlib, Seaborn, Numpy, Catboost, GradientBoosting, DecisionTree, LGBM, StandardScaler ,RandomizedSearchCV | [Link](https://github.com/Vol4uk13/master/tree/master/Numerical_methods) |
